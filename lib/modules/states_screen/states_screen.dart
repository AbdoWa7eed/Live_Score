...
class StatsScreen extends StatelessWidget {
                              ...
                              children: [
                                Expanded(
                                    child: MaterialButton(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(
                                            color: cubit.detailsIndex == 0 ? defaultColor :  Colors.grey[200],
                                            borderRadius: BorderRadius.circular(10)
                                        ),
                                        height: 40,
                                        child:  Center(child: Text('Stats' , style:
                                        TextStyle(
                                            color: cubit.detailsIndex == 0 ? Colors.white :  Colors.grey[500] ,
                                ...
                                Expanded(
                                    child: MaterialButton(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(
                                            color: cubit.detailsIndex == 1 ? defaultColor :  Colors.grey[200],
                                            borderRadius: BorderRadius.circular(10)
                                        ),
                                        height: 40,
                                        child:  Center(child: Text('Line-Up' , style: TextStyle(color: cubit.detailsIndex == 1 ? Colors.white :  Colors.grey[500] ,
                                            fontSize: 15 , fontWeight: FontWeight.bold ),)),
                                      ),
                                    )
                                ),
                                ...
                                Expanded(
                                    child: MaterialButton(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(
                                            color: cubit.detailsIndex == 2 ? defaultColor :  Colors.grey[200],
                                            borderRadius: BorderRadius.circular(10)
                                        ),
                                        height: 40,
                                        child:  Center(child: Text('Events' , style: TextStyle(color: cubit.detailsIndex == 2 ? Colors.white :  Colors.grey[500],
                                            fontSize: 15 , fontWeight: FontWeight.bold ),)),
                                      ),
                                    )
                                ),
                        ...
                        child: Column(
                          ...
                          children: [
                            if(cubit.detailsIndex == 0)...[
                             ConditionalBuilder(condition: cubit.statsModel != null,
                                 builder: (context) {
                                  if( cubit.statsModel!.response.isNotEmpty)
                                    {
                                      return  Expanded(
                                        child: ListView.builder(
                                          physics: BouncingScrollPhysics(),
                                          itemBuilder: (context, index) {
                                            return buildStatsItem(cubit.statsModel! , index);
                                          },
                                          itemCount: cubit.statsModel!.response[0].statistics!.length,
                                        ),
                                      );
                                    }
                                  return Center(
                                    child: Text('No Stats Available' , style: TextStyle(fontSize: 20),),
                                  );
                                 },
                            ...
                            [
                              ConditionalBuilder(condition: true,
                                builder: (context) {
                                  ...
                                  {
                                    return Expanded(child: buildLineUpItem(cubit.lineUp!));
                                  }
                                  return Center(
                                       child: Text('No Line Up Available' , style: TextStyle(fontSize: 20),),
                                     );

                                },
                                fallback: (context) => Center(child: CircularProgressIndicator()),),
                            ] else ...[
                              ConditionalBuilder(condition: cubit.events != null,
                                builder: (context) {
                                  if( cubit.events!.response!.isNotEmpty)
                                  {
                                    return  Expanded(
                                      child: ListView.separated(
                                        physics: BouncingScrollPhysics(),
                                        itemBuilder: (context, index) {
                                          return buildEventItem(cubit.events!.response![index]);
                                        },
                                        ...
                                        itemCount: cubit.events!.response!.length,
                                      ),
                                    );
                                  }
                                  return Center(
                                    child: Text('No Events Available' , style: TextStyle(fontSize: 20),),
                                  );
                                },
                                fallback: (context) => Center(child: CircularProgressIndicator()),),
                            ]
            ...
            child: Column(
              ...
              children: [
                Text(maxLines: 1,
                    ...
                    '${model.response[0].team!.name} ', style: TextStyle(fontSize: 15)),
                ListView.builder(
                  shrinkWrap: true,
        ...
        Expanded(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text('${model.response[1].team!.name} ', style: TextStyle(fontSize: 15)),
                ListView.builder(
                  shrinkWrap: true,
                  physics: NeverScrollableScrollPhysics(),
                  itemBuilder: (context, index) {
  ...
  Widget buildEventItem(EventModel model)
  {
    return Padding(
        ...
        children: [
          ...
          if(model.type == "Goal")...[
            Expanded(
              child: model.assist!.name != null ? Text('Goal , ${model.team!.name} Scored by ${model.player!.name} Assist ${model.assist!.name}' ,
                  overflow: TextOverflow.ellipsis,
                  maxLines: 3, style: TextStyle(
                    fontSize: 13,
                  )) : Text('Goal , ${model.team!.name} Scored by ${model.player!.name}' ,
                  overflow: TextOverflow.ellipsis,
                  maxLines: 3, style: TextStyle(
                    fontSize: 13,
                  )),
            ...
            Expanded(
              child: Text('Subsitution , ${model.team!.name}. ${model.assist!.name} replaces ${model.player!.name}' ,
                  overflow: TextOverflow.ellipsis,
                  maxLines: 3, style: TextStyle(
                    fontSize: 13,
                  )),
            ...
            Expanded(
              child: Text('${model.detail} for ${model.player!.name} (${model.team!.name}). ' ,
  ...
  {
    double first , second;
    if(model.response[1].statistics![index].value!.contains('%') ||model.response[0].statistics![index].value!.contains('%') )
      {
      ...
      child: Column(
        children: [
          Row(
            children: [
              Expanded(
                child: Text('${model.response[0].statistics![index].value}' , style: TextStyle(
                  color: premierColor , fontWeight: FontWeight.bold ,
                ),),
              ),
              Expanded(
                flex: 2,
                  child:
              Center(
                child: Text('${model.response[1].statistics![index].type}',
                  maxLines: 1,
                  style: TextStyle(
              ...
              Expanded(
                child: Align(
                  ...
                  child: Text('${model.response[1].statistics![index].value}' , style: TextStyle(
              ...
              children: [
                Expanded(
                  child: Container(
                    ...
                    child: FractionallySizedBox(
                      widthFactor: (first + second) == 0 ? 0 : (first/(first+second)),
                      alignment: AlignmentDirectional.centerEnd,
                      child: Container(
                        decoration: BoxDecoration(
                            color: premierColor,
                ...
                Expanded(
                  child: Container(
                    ...
                    height: 6,
                    child: FractionallySizedBox(
                      widthFactor: (first + second) == 0 ? 0 : (second/(first+second)),
                          ...
                          children: [
                            ...
                            Stack(
                              ...
                              children: [
                                ...
                                Text("${model.fixture!.status!.elapsed}'" , style: TextStyle(
                                    color: Colors.black
                                ),)
                              ],
                            )
